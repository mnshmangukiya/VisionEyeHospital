    ...
    return (
        <div>
            ...
            <div class="container-fluid d-flex footer z-1 position-relative" style={{ justifyContent: 'center', backgroundColor: '#1C2434' }}>
                ...
                <svg className='svgtwo' xmlns="http://www.w3.org/2000/svg" width="91" height="65" viewBox="0 0 91 65" fill="none" style={{ position: 'absolute', right: 0 + 'px', marginTop: 500 + 'px' }}>
                    <g opacity="0.3" >
                ...
                <div className="container">
                    <div className="row" style={{ marginTop: 150, marginLeft: 0, marginRight: 20 }}>
                        <div className="col-lg">
                            <h5 className='text12' style={{ color: '#E2E8F0' }}>About Us</h5>
                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="2" viewBox="0 0 46 2" fill="none" style={{ marginTop: -40 }}>
                                <path d="M45 1H1" stroke="#E2E8F0" stroke-width="2" stroke-linecap="round" />
                            </svg>
                            <img src={img1} alt="" width="122" height="60" className='me-auto d-block' />
                            <p>​Vision Eye Hospital was established pecialized tertiary eye care services at affordable prices  the city.Read More…</p>
                        </div>
                        <div class="col-lg">
                            <h5 className='text12' style={{ color: '#E2E8F0' }}>Pages</h5>
                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="2" viewBox="0 0 46 2" fill="none" style={{ marginTop: -40 }}>
                                <path d="M45 1H1" stroke="#E2E8F0" stroke-width="2" stroke-linecap="round" />
                            </svg>
                        ...
                        <div class="col-lg">
                            <h5 className='text12' style={{ color: '#E2E8F0' }}>Parle Point Branch</h5>
                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="2" viewBox="0 0 46 2" fill="none" style={{ marginTop: -50 }}>
                                <path d="M45 1H1" stroke="#E2E8F0" stroke-width="2" stroke-linecap="round" />
                            </svg>
                            <p className='mb-1 time'>Time : 9:30 AM to 6:00 PM</p>
                            <div className='d-flex'>
                                <p><a className='ms-0' href='#'>Get the Direction</a></p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none" style={{ marginTop: 30, marginLeft: 10 }}>
                        ...
                        <div class="col-lg">
                            <h5 className='text12' style={{ color: '#E2E8F0' }}>Parvat Patiya Branch</h5>
                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="2" viewBox="0 0 46 2" fill="none" style={{ marginTop: -50 }}>
                                <path d="M45 1H1" stroke="#E2E8F0" stroke-width="2" stroke-linecap="round" />
                            </svg>
                            <p className='mb-1 time'>Time : 6:00 PM to 9:00 PM</p>
                            <div className='d-flex'>
                                <p><a className='ms-0' href='#'>Get the Direction</a></p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none" style={{ marginTop: 30, marginLeft: 10 }}>
                                    <path d="M17.308 10.0231L11.1417 3.76748C10.8736 3.49938 10.4566 3.49938 10.1885 3.76748C9.92039 4.03558 9.92039 4.45262 10.1885 4.72072L15.193 9.81459H2.53279C2.17533 9.81459 1.87744 10.1125 1.87744 10.4699C1.87744 10.8274 2.17533 11.1551 2.53279 11.1551H15.2526L10.1885 16.3085C9.92039 16.5766 9.92039 16.9937 10.1885 17.2618C10.3076 17.3809 10.4864 17.4405 10.6651 17.4405C10.8438 17.4405 11.0226 17.3809 11.1417 17.232L17.308 10.9763C17.5761 10.7082 17.5761 10.2912 17.308 10.0231Z" fill="white" stroke="white" stroke-width="0.595774" />
                        ...
                        <div class="col-lg">
                            <h5 className='text12' style={{ color: '#E2E8F0' }}>Contact Us</h5>
                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="2" viewBox="0 0 46 2" fill="none" style={{ marginTop: -50 }}>
                                <path d="M45 1H1" stroke="#E2E8F0" stroke-width="2" stroke-linecap="round" />
                            </svg>
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-start py-4 my-4 border-top">
                        <p style={{ marginTop: 0 }}>&copy; Copyright © 2017 Vision Eye Hospital. Developed and Maintained by Sanskruti Technologies</p>
                        <ul class="list-unstyled d-flex" className='ms-auto d-flex'>
                            <li class="me-3">
