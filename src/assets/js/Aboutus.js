  ...
  return (
    <div>
        ...
        <div className="container welcome">
          <div className='row' >
            <div className='col-lg-6 d-flex justify-content-center'>
              <img src={img34} alt="Your Image" className='my-auto' style={{ height: 500, width: 500 }} />
            </div>
      ...
      <div className='container-fluid py-5 aboutmain' style={{ marginTop: 100 + 'px', backgroundColor: '#F1F5F9' }}>
        ...
        <div className="container welcome">
          <div className='row' >
            <div class="jumbotron col-lg-6 order-1 order-lg-0 medical mx-auto d-block">
              <div className="about">
            ...
            <div className='col-lg-6 order-0 order-lg-1 medicalimg ms-auto d-block' >
              <div className='rec5 '>
              ...
              <div>
                <img src={img40} alt="Your Image" style={{ width: 500, height: 440, marginTop: 20, position: 'absolute', zIndex: 2 }} />
                <img src={img42} alt="Your Image" style={{ width: 480, height: 420, marginTop: 40, position: 'absolute', zIndex: 1 }} />
              </div>
            </div>
          </div>
        </div>
